...
export default function ControlledExpansionPanels({ user }) {
    ...
    <div className={classes.root}>
      ...
      >
        ...
        >
          ...
          <Typography className={classes.secondaryHeading}>
            <FormattedMessage id="userInfo" defaultMessage="Accordion tab" />
          </Typography>
        </ExpansionPanelSummary>
        <ExpansionPanelDetails style={{ flexDirection: "column" }}>
          <div className={classes.wrapper}>
            <img src={user.picture} alt="logo" className={classes.images} />
            <h2>{user.name}</h2>
          </div>
          <h3 style={{ textAlign: "left", marginLeft: 70 }}>
            Nickname: <i>{user.nickname}</i>
          </h3>
      ...
      >
        ...
        >
          ...
          <Typography className={classes.secondaryHeading}>
            <FormattedMessage id="ownerInfo" defaultMessage="Accordion tab" />
          </Typography>
        </ExpansionPanelSummary>
        <ExpansionPanelDetails>
